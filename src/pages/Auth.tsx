...
// Password schema with enhanced complexity requirements for defense-in-depth
// Note: Supabase Auth provides server-side validation, this adds client-side UX
...
// Username schema with alphanumeric validation (server-side also validates via trigger)
